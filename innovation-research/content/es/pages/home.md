...
<section class="section section-alt" id="roadmap">
  <div class="section-content">
    <h2 class="section-title">{{ content.es.roadmap.title }}</h2>

    <div class="roadmap-container relative">
      <div class="roadmap-line"></div>
      {{ for phase of content.es.roadmap.phases }}
  ...
  <div class="section-content">
    ...
    <div class="flex justify-center w-full">
      <div class="team-member max-w-xs">
        ...
        <p class="team-role">{{ content.es.about.team_title }}</p>
    ...
    <p class="text-center text-text-muted mt-8">Benedikt trabaja toda su carrera en innovación y excelencia de equipo. Está desarrollando un sistema que utiliza la innovación en una gran variedad de contextos para el beneficio del éxito futbolístico. Sus hipótesis, argumentos e investigación relevante serán finalmente publicados como un libro a principios de 2026.</p>
  </div>
</section>
